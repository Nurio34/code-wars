...
// if you have it in your database. It should default to English if the language is not in the database, or
...
let obj = []
     ...
     obj = database.find(item=> {
        if(language == Object.keys(item)) {
            return item
        }
    })
